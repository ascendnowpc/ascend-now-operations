...
// The aggregation itself lives in ./reportAggregation (pure, unit-tested).
// Re-exported here so existing importers of buildInvoicePdf keep working.
export {
...
import type { ReportSection, ReportBlock } from "./reportAggregation";
import { groupSectionsIntoBlocks } from "./reportAggregation";
